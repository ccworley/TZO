...
nir1= '/home/cclare/Stars/TZO/'+version+'XSHOO.2015-10-20T23:53:45.418/HV2112_SCI_SLIT_FLUX_MERGE1D_NIR.fits'
hdulist = fits.open(nir1)
nir1datatab = hdulist[ext].data
nir1dataraw = nir1datatab.FLUX
...
nir1wave = nir1datatab.LAMBDA   #np.arange(swave1,ewave1,sdelt1)
nir1waveclean = nir1wave[in1v]
nir1data = np.interp(nir1wave, nir1waveclean, nir1dataclean)


nir2= '/home/cclare/Stars/TZO/'+version+'XSHOO.2015-10-21T00:04:16.573/HV2112_SCI_SLIT_FLUX_MERGE1D_NIR.fits'
hdulist = fits.open(nir2)
nir2datatab = hdulist[ext].data
nir2dataraw = nir2datatab.FLUX
...
nir2wave = nir2datatab.LAMBDA   #np.arange(swave2,ewave2,sdelt2)
nir2waveclean = nir2wave[in2v]
nir2data = np.interp(nir1wave, nir2waveclean, nir2dataclean)


nir3= '/home/cclare/Stars/TZO/'+version+'XSHOO.2015-10-21T00:14:41.737/HV2112_SCI_SLIT_FLUX_MERGE1D_NIR.fits'
hdulist = fits.open(nir3)
nir3datatab = hdulist[ext].data
nir3dataraw = nir3datatab.FLUX
...
nir3wave = nir3datatab.LAMBDA   #np.arange(swave3,ewave3,sdelt3)
nir3waveclean = nir3wave[in3v]
nir3data = np.interp(nir1wave, nir3waveclean, nir3dataclean)

nir4= '/home/cclare/Stars/TZO/'+version+'XSHOO.2015-10-21T00:25:06.237/HV2112_SCI_SLIT_FLUX_MERGE1D_NIR.fits'
hdulist = fits.open(nir4)
nir4datatab = hdulist[ext].data
nir4dataraw = nir4datatab.FLUX
...
nir4wave = nir4datatab.LAMBDA   #np.arange(swave4,ewave4,sdelt4)
nir4waveclean = nir4wave[in4v]
nir4data = np.interp(nir1wave, nir4waveclean, nir4dataclean)

nir5= '/home/cclare/Stars/TZO/'+version+'XSHOO.2015-10-21T00:35:30.070/HV2112_SCI_SLIT_FLUX_MERGE1D_NIR.fits'
hdulist = fits.open(nir5)
nir5datatab = hdulist[ext].data
nir5dataraw = nir5datatab.FLUX
...
nir5wave = nir5datatab.LAMBDA  #np.arange(swave5,ewave5,sdelt5)
